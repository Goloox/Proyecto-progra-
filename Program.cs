            ...
            static void IncluirEstudiantes()
            {
                for (int i = 0; i < estudiantes.Length; i++)
                {
                    if (estudiantes[i] == null)
                    {
                        ...
                        {
                            Console.WriteLine("");
                            Console.WriteLine("Error: El promedio debe ser un valor numérico.");
                            Console.WriteLine("");
                            return;
                        }
            ...
            static void ConsultarEstudiantes()
            {
                ...
                foreach (var estudiante in estudiantes)
                {
                    if (estudiante != null && estudiante.Cedula == cedula)
                    {
                        Console.WriteLine("" +
                            "===================================================================================================================================================" +
                            $"Cédula: {estudiante.Cedula}, Nombre: {estudiante.Nombre}, Promedio: {estudiante.Promedio}, Condición: {estudiante.Condicion}" +
                            "==================================================================================================================================================" +
